...
<!-- Notes:
- Host GIFs/images in this profile repo under /assets and use raw.githubusercontent URLs; GitHub supports GIFs directly in README [StackOverflow ref].
- Keep GIFs small (<1–2 MB) for performance; prefer subtle loops (lines/charts) over distracting animations.
- Tables render reliably on GitHub and create neat “tiles” without custom CSS.
-->
